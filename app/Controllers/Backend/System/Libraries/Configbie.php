	...
	public function system(){
		$data['homepage'] =  array(
			...
			'value' => array(
				...
				'ft' => array('type' => 'editor', 'label' => 'Text chân trang'),
				'ft_2' => array('type' => 'editor', 'label' => 'Text chân trang 2'),
				'time' => array('type' => 'editor', 'label' => 'Giờ phục vụ'),
		...
		$data['contact'] =  array(
			...
			'value' => array(
				...
				'link_bct' => array('type' => 'text', 'label' => 'Link bộ công thương'),
				'link_dmca' => array('type' => 'text', 'label' => 'Link DMCA'),
		...
		$data['camket'] =  array(
			...
			'value' => array(
				...
				'banner' => array('type' => 'images', 'label' => 'Banner ảnh'),
				'banner_title' => array('type' => 'text', 'label' => 'Tiêu đề banner ảnh'),
				'banner_description' => array('type' => 'text', 'label' => 'Mô tả banner ảnh'),
				'block_1_number' => array('type' => 'text', 'label' => 'Số khối 1'),
				'block_1_title' => array('type' => 'text', 'label' => 'Tiêu đề khối 1'),
				'block_1_description' => array('type' => 'text', 'label' => 'Mô tả khối 1'),
				'block_2_number' => array('type' => 'text', 'label' => 'Số khối 2'),
				'block_2_title' => array('type' => 'text', 'label' => 'Tiêu đề khối 2'),
				'block_2_description' => array('type' => 'text', 'label' => 'Mô tả khối 2'),
				'block_3_number' => array('type' => 'text', 'label' => 'Số khối 3'),
				'block_3_title' => array('type' => 'text', 'label' => 'Tiêu đề khối 3'),
				'block_3_description' => array('type' => 'text', 'label' => 'Mô tả khối 3'),
				'block_4_number' => array('type' => 'text', 'label' => 'Số khối 4'),
				'block_4_title' => array('type' => 'text', 'label' => 'Tiêu đề khối 4'),
				'block_4_description' => array('type' => 'text', 'label' => 'Mô tả khối 4'),
			),
		);
		// $data['banner'] =  array(
		// 	'label' => 'Cấu hình khác',
